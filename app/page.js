  ...
  return (
    <>
      ...
      <div className="card">
        ...
        <div className="rowb"><b className="k" style={{ color: 'var(--chalk)' }}>Cash the books expect</b>
      ...
      <div className="card">
        ...
        {counted && (
          <>
            ...
            <div className="rowb"><span className="k">Books say</span><span className="v">{money(cashPerBooks)}</span></div>
